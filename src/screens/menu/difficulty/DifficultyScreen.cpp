...
void DifficultyScreen::onEnter() {
    ...
    easy_.bgRel = med_.bgRel = hard_.bgRel = "sprites/menu/buttons/1384.png";
    easy_.bgRelActive = med_.bgRelActive = hard_.bgRelActive = "sprites/menu/buttons/1384.png";
}
...
void DifficultyScreen::draw(const DrawContext& ctx) {
    ...
    if (mode_ == "free") {
        auto t = ctx.assets->tex("sprites/menu/russian/0055.png").tex;
        DrawTexture(t, 10, 24, WHITE);
    } else {
        auto t = ctx.assets->tex("sprites/menu/russian/0017.png").tex;
        DrawTexture(t, 10, 24, WHITE);
    }

    drawDiffRow(ctx, easy_, "sprites/menu/buttons/1234.png", "sprites/menu/russian/0024.png", false);
    drawDiffRow(ctx, med_,  "sprites/menu/buttons/1235.png", "sprites/menu/russian/0025.png", false);
    drawDiffRow(ctx, hard_, "sprites/menu/buttons/1236.png", "sprites/menu/russian/0026.png", !ctx.profile->storyCompleted);
